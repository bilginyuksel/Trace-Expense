...
import 'package:trace_expanses/repository/baseRepository.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _incrementCounter() async{
    ...
    // await base.addSomeExpense();
    // print("SUM: "+(await base.getSum()).toString());
    await base.getExpenses();
    print((await base.getSum()).toString());
    await base.close();
    setState(() {
